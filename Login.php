...
?>  
 <header class="header">
    ...
    <section class="signup">
        ...
        <h2 style="display: flex; justify-content: center; font-family: Santral W01;">Login</h2><br>
                ...
                <div class="signup-form">
                    ...
                    <form method="POST" class="register-form" id="register-form">
                        ...
                        <div class="form-group form-button">
                            <button type="submit" name="signup" id="signup" class="form-submit" value="Register">login</button>
                           
                        </div>
                        <div class="login-page">
                            <a  style='color:#000' href="Register.php" class="signup-image-link">No Account?, Sign in</a>
                        </div>
