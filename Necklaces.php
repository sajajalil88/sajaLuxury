...
<?php include "Header.php" ?>
    <div class="back-shop">
      <img style="width: 100%; height:10%;" src="images/necklaces.png" alt="/" />
    </div>
    <div class="rings-shop">
        ...
        <div class="product-details"  id="product-1">
         ...
         <div  class="change-img-hover">
             <div class="img-normal">
               <img id="image1" src="images/slid1.jpg" alt="vision" >
             </div>
             <div class="img-hover"  onclick="viewProduct('product-1')">
               <img id="image2" src="images/slidH1.jpg" alt="desk">
               <img id="image3" src="images/slidH1view1.jpg" alt="desk">
               <img id="image4" src="images/slidH1view2.jpg" alt="desk">
             </div>
            </div>
         <p class="p-name" id="name">Boyfriend Bold Chain Necklace</p>
         <div class="desc-price">
         <p class="p-description" id="description">14k Yellow Gold</p>
         <p class="p-price" id="price">$300</p>
         </div>
        ...
        <div  class="product-details"  id="product-3">
         <div class="change-img-hover">
             <div class="img-normal">
               <img id="image1" src="images/slid16.jpg" alt="vision">
             </div>
             <div class="img-hover" onclick="viewProduct('product-3')">
               <img id="image2" src="images/slidH16.jpg" alt="desk">
               <img id="image3" src="images/slidH16view1.jpg" alt="desk">
               <img id="image4" src="images/slidH16view2.jpg" alt="desk">
             </div>
           </div>
         <p class="p-name">Snake gold Necklace</p>
         <div class="desc-price">
         <p class="p-description">14k Yellow Gold</p>
        ...
        <div  class="product-details"  id="product-5">
         <div class="change-img-hover">
             <div class="img-normal">
               <img id="image1" src="images/slid14.jpg" alt="vision">
             </div>
             <div class="img-hover" onclick="viewProduct('product-5')">
               <img id="image2" src="images/slidH14.jpg" alt="desk">
               <img id="image3" src="images/slidH14view1.jpg" alt="desk">
               <img id="image4" src="images/slidH14view2.jpg" alt="desk">
             </div>
           </div>
         <p class="p-name">Trienome gold Necklace</p>
         <div class="desc-price">
         <p class="p-description">14k Yellow Gold</p>
        ...
        <div  class="product-details"  id="product-7">
         <div class="change-img-hover">
             <div class="img-normal">
               <img id="image1" src="images/slid8.jpg" alt="vision">
             </div>
             <div class="img-hover" onclick="viewProduct('product-7')">
                 <img id="image2" src="images/slidH8.jpg" alt="desk">
                 <img id="image3" src="images/slidH8view1.jpg" alt="desk">
                 <img id="image4" src="images/slidH8view2.jpg" alt="desk">
             </div>
           </div>
         <p class="p-name">Eyes gold Chain Necklace</p>
         <div class="desc-price">
         <p class="p-description">14k Yellow Gold</p>
        ...
        <div  class="product-details" id="product-8">
            <div class="change-img-hover">
                <div class="img-normal">
                  <img id ="image1" src="images/slid9.jpg" alt="vision">
                </div>
                <div class="img-hover" onclick="viewProduct('product-8')">
                  <img id="image2" src="images/slidH9.jpg" alt="desk">
                  <img id="image3" src="images/slidH9view1.jpg" alt="desk">
                  <img id="image4" src="images/slidH9view2.jpg" alt="desk">
                </div>
              </div>
            <p class="p-name">Eye Doted thin goldNecklace</p>
            <div class="desc-price">
            <p class="p-description">12k Yellow Gold</p>
            <p class="p-price">$350</p>
            </div>
           ...
           <div  class="product-details"  id="product-10">
            <div class="change-img-hover">
                <div class="img-normal">
                  <img id="image1" src="images/slid11.jpg" alt="vision">
                </div>
                <div class="img-hover"  onclick="viewProduct('product-10')">
                  <img id="image2" src="images/slidH11.jpg" alt="desk">
                  <img id="image3" src="images/slidH11view1.jpg" alt="desk">
                  <img id="image4" src="images/slidH11view2.jpg" alt="desk">
                </div>
              </div>
            <p class="p-name"> Thin Single gold Necklace</p>
            <div class="desc-price">
            <p class="p-description">14k Yellow Gold</p>
